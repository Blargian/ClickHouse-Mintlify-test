...
<img src="/images/managed-postgres/pg_dump_restore/source-setup.png" alt="Source PostgreSQL Database Setup" />
...
<img src="/images/managed-postgres/pg_dump_restore/dump-command.png" alt="pg_dump Command Execution" />
...
First, ensure you have a Managed Postgres instance set up, preferably in the same region as the source. You can follow the quick guide [here](/docs/managed-postgres/quickstart#create-postgres-database). Here's what we're going to spin up for this guide:
...
pg_restore \
  ...
  rds-dump
```
You can get the connection string for your Managed Postgres instance from the ClickHouse Cloud console, explained very simply [here](/docs/managed-postgres/connection).
...
<img src="/images/managed-postgres/pg_dump_restore/restore-command.png" alt="pg_restore Command Execution" />
...
<img src="/images/managed-postgres/pg_dump_restore/target-setup.png" alt="Target Managed Postgres Database Setup" />
