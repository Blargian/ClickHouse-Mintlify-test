...
<img src="/images/managed-postgres/create-service.png" alt="Create a managed Postgres service" />

Enter a name for your database instance and click on **Create service**. You will be taken to the overview page.

<img src="/images/managed-postgres/overview.png" alt="Managed Postgres overview" />

Your Managed Postgres instance will be provisioned and ready for use in 3-5 minutes.

### Connect to your database

In the sidebar on the left, you will see a [**Connect** button](/docs/managed-postgres/connection). Click on it to view your connection details and connection strings in multiple formats.

<img src="/images/managed-postgres/connect-modal.png" alt="Managed Postgres connect modal" />
...
<Note title="Your Postgres is ready">
...
<img src="/images/managed-postgres/integration-landing.png" alt="Managed Postgres integration empty" />
...
<img src="/images/managed-postgres/postgres-analytics-form.png" alt="Managed Postgres integration form" />
...
<img src="/images/managed-postgres/table-picker.png" alt="Managed Postgres table picker" />
...
<img src="/images/managed-postgres/get-clickhouse-host.png" alt="Get ClickHouse host" />
...
<img src="/images/managed-postgres/analytics-list.png" alt="Managed Postgres analytics list" />

Click on the service name to open the ClickHouse console and see your replicated tables.

<img src="/images/managed-postgres/replicated-tables.png" alt="Managed Postgres replicated tables in ClickHouse" />
...
<Tip title="When to use ClickHouse">
