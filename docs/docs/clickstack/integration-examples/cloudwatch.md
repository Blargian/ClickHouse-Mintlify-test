...
<img src="/images/clickstack/api_key" alt="ClickStack API Key" />
...
<img src="/images/clickstack/log_search_view" alt="Log Search View" />
...
<img src="/images/clickstack/error_log_column_values" alt="Error Log Column Values" />
...
<img src="/images/clickstack/demo_search_view" alt="Demo search view" />
...
#### [Download](/examples/cloudwatch-logs-dashboard.json) the dashboard configuration
...
<img src="/images/clickstack/import_dashboard" alt="Import dashboard button" />

3. Upload the `cloudwatch-logs-dashboard.json` file and click **Finish Import**

<img src="/images/clickstack/finish_import" alt="Finish import dialog" />

#### View the dashboard

The dashboard will be created with all visualizations pre-configured:

<img src="/images/clickstack/example_dashboard" alt="CloudWatch Logs dashboard" />
