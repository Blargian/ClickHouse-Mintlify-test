                ...
                <>
                    ...
                    <div className="mt-6 grid sm:grid-cols-2 min-[1300px]:grid-cols-4 gap-x-6 gap-y-4">
                        ...
                        <HeroCard
                            ...
                            description="Kubernetes operator that automates deploying, configuring, and managing ClickHouse and ClickHouse Keeper clusters on Kubernetes."
                            icon={
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 256 256" className="text-gray-700 dark:text-[#FAFF69]">
                                    <path d="M208,32H48A16,16,0,0,0,32,48V208a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V48A16,16,0,0,0,208,32Zm0,176H48V48H208V208ZM88,112a8,8,0,0,1,8-8h16V88a8,8,0,0,1,16,0v16h16a8,8,0,0,1,0,16H128v16a8,8,0,0,1-16,0V128H96A8,8,0,0,1,88,112Zm96,56a8,8,0,0,1-8,8H80a8,8,0,0,1,0-16h96A8,8,0,0,1,184,168Z"></path>
                                </svg>
                            }
                        ...
                        <HeroCard
                            ...
                            icon={
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" viewBox="0 0 256 256" className="text-gray-700 dark:text-[#FAFF69]">
                                    <path d="M200,48H136V16a8,8,0,0,0-16,0V48H56A32,32,0,0,0,24,80V192a32,32,0,0,0,32,32H200a32,32,0,0,0,32-32V80A32,32,0,0,0,200,48Zm16,144a16,16,0,0,1-16,16H56a16,16,0,0,1-16-16V80A16,16,0,0,1,56,64H200a16,16,0,0,1,16,16Zm-36-76a36,36,0,1,1-36-36A36,36,0,0,1,180,116Zm-16,0a20,20,0,1,0-20,20A20,20,0,0,0,164,116ZM112,116a36,36,0,1,1-36-36A36,36,0,0,1,112,116Zm-16,0a20,20,0,1,0-20,20A20,20,0,0,0,96,116Zm84,52a8,8,0,0,1-8,8H84a8,8,0,0,1,0-16h88A8,8,0,0,1,180,168Z"></path>
                                </svg>
                            }
                            href="/docs/agent-data-stack"
                        />
                    </div>
                </>
            )}
