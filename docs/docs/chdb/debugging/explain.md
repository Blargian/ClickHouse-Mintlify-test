...
────────────────────────────────────────────────────────────────────────────────
     ...
     Note: SQL operations after Pandas ops use Python() table function
...
| chDB | chDB (SQL) operation |
| pandas | pandas operation |
...
Operations:
────────────────────────────────────────────────────────────────────────────────
     Segment 1 [chDB] (from source): Operations 2-2
...
Operations:
────────────────────────────────────────────────────────────────────────────────
     Segment 1 [chDB] (from source): Operations 2-8
...
Operations:
────────────────────────────────────────────────────────────────────────────────
     Segment 1 [chDB] (from source): Operations 2-4
     Segment 2 [Pandas] (on DataFrame): Operation 5
     Segment 3 [chDB] (on DataFrame): Operation 6
     Note: SQL operations after Pandas ops use Python() table function
