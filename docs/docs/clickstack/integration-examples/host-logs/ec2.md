...
<img src="/images/clickstack/search_view" alt="EC2 logs search view" />
<img src="/images/clickstack/log_view" alt="EC2 log detail showing metadata" />
...
<img src="/images/clickstack/search_view_demo" alt="EC2 logs search view" />
<img src="/images/clickstack/log_view_demo" alt="EC2 log detail with metadata" />
...
#### [Download](/examples/host-logs-dashboard.json) the dashboard configuration
...
<img src="/images/clickstack/finish_import" alt="Finish import" />

#### View the dashboard

The dashboard will be created with all visualizations pre-configured:

<img src="/images/clickstack/logs_dashboard" alt="EC2 logs dashboard" />
