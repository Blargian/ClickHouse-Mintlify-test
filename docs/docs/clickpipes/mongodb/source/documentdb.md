...
![Select parameter group](/images/integrations/data-ingestion/clickpipes/mongodb/docdb-select-parameter-group.png)

2. Search for `change_stream_log_retention_duration`, select and edit it to `259200` (72 hours)
![Modify parameter group](/images/integrations/data-ingestion/clickpipes/mongodb/docdb-modify-parameter-group.png)
...
![Apply parameter group](/images/integrations/data-ingestion/clickpipes/mongodb/docdb-apply-parameter-group.png)

![Parameter group status](/images/integrations/data-ingestion/clickpipes/mongodb/docdb-parameter-group-status.png)
