...
<img src="/images/clickstack/search_view" alt="Log search view" />

<img src="/images/clickstack/log_view" alt="Log view" />
...
#### [Download](/examples/systemd-logs-dashboard.json) the dashboard configuration
