...
<img src="/images/clickstack/logs_search_view" alt="Logs search view" />
...
#### [Download](/examples/postgres-logs-dashboard.json) the dashboard configuration
...
<img src="/images/clickstack/logs_dashboard" alt="Logs dashboard" />
