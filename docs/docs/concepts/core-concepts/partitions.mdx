...
<img src="/images/managing-data/core-concepts/partitions.png" alt="INSERT PROCESSING"/>
...
<img src="/images/managing-data/core-concepts/merges_with_partitions.png" alt="PART MERGES"/>
...
<RunnableCode sql={`SELECT DISTINCT _partition_value AS partition
...
<RunnableCode sql={`SELECT MAX(price) AS highest_price
FROM uk.uk_price_paid_simple_partitioned
...
<img src="/images/managing-data/core-concepts/partition-pruning.png" alt="PART MERGES 2"/>
