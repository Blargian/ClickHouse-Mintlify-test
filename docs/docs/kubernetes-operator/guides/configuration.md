...
See [API Reference](/clickhouse-operator/reference/api-reference#podtemplatespec) for all supported Pod template options.
...
See [API Reference](/clickhouse-operator/reference/api-reference#containertemplatespec) for all supported Container template options.
