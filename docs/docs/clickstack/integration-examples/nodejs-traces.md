...
<img src="/images/clickstack/search_view" alt="Traces search view" />

Click on any trace to see the detailed view with spans, timing, and attributes:

<img src="/images/clickstack/trace_view" alt="Individual trace view" />
...
#### [Download](/examples/nodejs-traces-dashboard.json) the dashboard configuration
...
<img src="/images/clickstack/import_dashboard" alt="Import Dashboard" />
...
<img src="/images/clickstack/example_dashboard" alt="Example dashboard" />
