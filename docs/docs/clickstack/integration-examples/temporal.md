...
#### [Download](/examples/temporal-metrics-dashboard.json) the dashboard configuration
...
<img src="/images/clickstack/example_dashboard" alt="Temporal Metrics dashboard" />
