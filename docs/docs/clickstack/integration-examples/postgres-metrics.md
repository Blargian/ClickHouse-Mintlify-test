...
#### [Download](/examples/postgres-metrics-dashboard.json) the dashboard configuration
...
<img src="/images/clickstack/example_dashboard" alt="PostgreSQL metrics dashboard" />
