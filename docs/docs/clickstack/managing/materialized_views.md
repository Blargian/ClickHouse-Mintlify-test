...
<img src="/images/clickstack/materialized_views/generated_sql.png" alt="Generated SQL" />
...
<img src="/images/clickstack/materialized_views/edit_source.png" alt="Edit sources" />

#### Add the materialized view

Select **Add materialized view**, then choose the database and target table that back the materialized view.

<img src="/images/clickstack/materialized_views/add_view.png" alt="Edit sources" />
...
<img src="/images/clickstack/materialized_views/select_metrics.png" alt="Select Metrics" />

#### Select the time granularity

Select the **time granularity** of the materialized view, for example, one minute.

<img src="/images/clickstack/materialized_views/select_time_granularity.png" alt="Select Time Granularity" />
...
<img src="/images/clickstack/materialized_views/select_min_time.png" alt="Select Min Time" />
...
<img src="/images/clickstack/materialized_views/save_source.png" alt="Save Source" />
...
<img src="/images/clickstack/materialized_views/accelerated_visual.png" alt="Accelerated Visualization" />
